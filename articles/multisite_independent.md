...
also need to change the `output_function` column to tell the `dr_output`
...
|:-----------------------------------------------|:----------------|
| Multi Site, Exploratory, Cross-Sectional       | dr_ms_exp_cs    |
| Multi Site, Exploratory, Longitudinal          | dr_ms_exp_la    |
| Multi Site, Anomaly Detection, Cross-Sectional | dr_ms_anom_cs   |
| Multi Site, Anomaly Detection, Longitudinal    | dr_ms_anom_la   |
...
`dr_output`. If you do not mind the lack of an overall comparison metric
