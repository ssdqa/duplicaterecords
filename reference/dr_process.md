...
(`dr_input_file`) to be evaluated and define any values that should be
...
package and are accessible with `duplicaterecords::`. Results can
...
- dr_input_file:
  ...
  *tabular input* \|\| **required**
  ...
  A table with information about each of the duplicate record
  definitions that should be examined in the analysis. This table should
  ...
  - `duplicate_columns` \| *character* \| the names of the columns that
    define duplication, either by including or excluding them
  ...
  [`?duplicaterecords::dr_input_file_omop`](https://ssdqa.github.io/duplicaterecords/reference/dr_input_file_omop.md)
  or
  [`?duplicaterecords::dr_input_file_pcornet`](https://ssdqa.github.io/duplicaterecords/reference/dr_input_file_pcornet.md)
...
duplicate records for each user-defined combination of columns. For a
